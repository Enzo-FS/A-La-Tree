...
@Component({
  ...
  styles: [`
    ...
    .dash-card:active { transform: scale(0.95); background: var(--surface); }
    ...
    .logout-btn { margin-top: 2rem; padding: 1rem; border-radius: var(--radius-sm); background: transparent; border: 2px solid var(--red); color: var(--red); font-weight: 700; cursor: pointer; transition: 0.2s; font-family: inherit; }
